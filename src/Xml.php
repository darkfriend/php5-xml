...
class Xml
{
     ...
     * @since 2.0.0
     */
    public static function getProlog($params = array())
    {
     ...
     */
    public static function generateXml($xml, $data, $params = array())
    {
     ...
     * @return SimpleXMLElement
     */
    public static function addChild($xml, $name, $params = '', $options = array())
    {
        if(\is_array($params)) {
            if(!empty($params[0])) {
